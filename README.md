...
- Database Schema:
  <img title="database schema" alt="Alt text" src="./vet-clinic-shema.png">
...
```sh
  cd my-folder
  git clone https://github.com/Mahamadou-Nouridine/vet-clinic-database
```
...
Feel free to check the [issues page](https://github.com/Mahamadou-Nouridine/vet-clinic-database/issues).
